...
<h1 align="center"><font >Leave Management System</font></h1>
...
?>
    ...
    <form action="process.php" method="post" id="signup"  onsubmit="return validate()">
        ...
        <div class="container el">
            ...
            <div class="row">
                ...
                <div class="col-8 stacked-el">
                    ...
                    <input type="text" name="phone" placeholder="543000391" id="phone" pattern="[0-9]{10}">
                </div>
            </div>
        </div>
 ...
 <script type="text/javascript">
                    function validate()
                    {
                        ...
                        var pass1=document.valid.txtpass1.value;
                    var pass2=document.valid.txtcpass1.value;
                    
                   
                        if(pass1.length<6)
                        {
                            alert("sorry!,password must be 6 characters");
                            return false;
                        }
                        if(pass1==pass2)
                        {
                        ...
                        var name=document.valid.txtname;
                        if(name=="")
                        {
                            alert("please,enter your name");
                        }
                        var a=document.getElementById("txtaaname").value;
                        var check=/^[a-zA-Z]+$/;
                        if(a.value.matches(check))
                        {
                            alert("sorry");
                        }
